...
function AppHero() {
  ...
  return (
    <div 
      className="relative max-w-5xl h-[30rem] mx-auto mt-12 overflow-hidden rounded-lg shadow-lg"
        ...
        {slides.map((slide, index) => (
          <div key={index} className={`absolute inset-0 transition-opacity duration-1000 ease-in-out ${index === currentIndex ? 'opacity-100' : 'opacity-0'}`}>
            ...
            <div className="absolute bottom-20 left-10 text-white z-10">
              ...
              <a href="#" className="inline-block mt-4 px-6 py-2 bg-indigo-600 rounded-lg text-white font-semibold shadow-lg hover:bg-indigo-500 hover:scale-105 transition">
                Learn More
              </a>
            </div>
          </div>
